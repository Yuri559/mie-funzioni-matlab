...
% mu              Coefficiente
% f(x,t)          Forzante (funzione di x e t)
% a, b            Estremi del dominio 1D
% us(t), ud(t)    Dati di Dirichlet rispettivamente in x = a e x = b
%                 (funzioni di t)
% g0(x)           Dato iniziale (funzione di x)
% T               Tempo finale
...
%
% Parametri di uscita:
% u               Soluzione numerica, matrice; il primo indice determina 
%                 il nodo nello spazio, il secondo indice l'istante 
%                 temporale (u(i,j) = soluzione approssimata al nodo x_i, 
%                 al tempo t_j)
% x               Vettore dei nodi di discretizzazione
% t               Vettore dei tempi discreti
%
