...
% metodo di Crank-Nicolson con metodo delle iterazioni di punto fisso
%
% y' = f(t,y)   t \in (0,t_max)
% y(0) = y_0
%
% Metodo di Crank-Nicolson : u^{n+1}=u^n+1/2*h*( f^n +f^{n+1}). 
...
% iter_pf   Vettore che contiene il numero di iterazioni di punto fisso 
